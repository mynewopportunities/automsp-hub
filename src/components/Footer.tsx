...
const footerLinks = {
  ...
  legal: [
    ...
    { name: 'Workplace Policy', href: '/workplace-policy' },
  ],
};
    ...
    <footer className="bg-foreground text-background" role="contentinfo">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
          ...
          {/* Content - Right side */}
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8">
            {/* Brand Info */}
            <div className="col-span-2 md:col-span-3 lg:col-span-1">
              <p className="text-background/70 text-sm mb-3 leading-relaxed">
            ...
            {/* Solutions */}
            <div>
              <h3 className="font-bold font-heading mb-2 text-sm">Solutions</h3>
            ...
            {/* Resources */}
            <div>
              <h3 className="font-bold font-heading mb-2 text-sm">Resources</h3>
              <ul className="space-y-1.5">
            ...
            {/* Company */}
            <div>
              <h3 className="font-bold font-heading mb-2 text-sm">Company</h3>
              <ul className="space-y-1.5">
            ...
            {/* Legal + Social */}
            <div>
              <h3 className="font-bold font-heading mb-2 text-sm">Legal</h3>
              <ul className="space-y-1.5">
              ...
              <div className="flex gap-2 mt-3">
                {socialLinks.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="w-6 h-6 rounded-md bg-background/10 hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-all duration-300"
